...
public class HardBotMoveController extends BotMoveController{
    ...
    protected int[] getMoveCoordinates() {
        ...
        if (field[1][1].trim().equals(Figure.O.toString()) &&
                ((field[1][0].trim().equals(Figure.X.toString())) || (field[0][1].trim().equals(Figure.X.toString())) || (field[1][2].trim().equals(Figure.X.toString())) || (field[2][1].trim().equals(Figure.X.toString()))) &&
